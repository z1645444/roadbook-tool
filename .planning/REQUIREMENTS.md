...
- [ ] **CONV-03**: User can provide trip date range and total trip days for planning.
- [ ] **CONV-04**: User can provide daily ride time window (for example, 08:00-17:00) and system applies it as hard constraint.
